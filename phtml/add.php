			...
			switch ($_GET['type']) {
				...
				case 'add_key_content':
					...
					$window_text = '
									...
									标题：<input type="text" name="title" style="width:600px;" /><br /><br />
									内容：<textarea name="con_content" rows="3" cols="80"></textarea><br /><br />
									描述：<textarea name="description" rows="3" cols="80"></textarea><br /><br />
									页面URL：<input type="text" name="url" /><br /><br />
