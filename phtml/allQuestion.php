...
$query = "select * from libQuestion where isChecked='1' order by ptime desc";
...
function onenode($question,mydb $dbObj){
	echo "<div data-role='content' style='margin:3px auto;width:80%;background-color:white;border:1px solid black;'>
			<strong>$question[3]</strong><div style='text-align:right;font-size:10px;'>$question[2]</div><br>";
			////////////回复
